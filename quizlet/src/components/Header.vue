...
#header {
  ...
  .left {
    ...
    .header-menu svg.arrow-icon {
      background-image: url("~@/assets/arrow-icon-3.svg");
      background-repeat: no-repeat;
      width: 12px;
      height: 12px;
      margin-left: 16px;
    ...
    .header-menu .header-menu-item:hover:active {
      color: #979690ff;
      background: #c3c2beff;
    }
    ...
    .header-menu .header-menu-item.selected .indicator {
      position: absolute;
      bottom: 0px;
      width: 100%;
      height: 4px;
